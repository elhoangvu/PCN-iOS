...
class MemoryOptimizationParameterDefaultTypeInternal;
extern MemoryOptimizationParameterDefaultTypeInternal _MemoryOptimizationParameter_default_instance_;
class NetParameter;
...
class NetParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.NetParameter) */ {
 ...
 private:
  ...
  void set_has_mem_param();
  void clear_has_mem_param();
...
class MemoryOptimizationParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.MemoryOptimizationParameter) */ {
 public:
  ...
  static inline const MemoryOptimizationParameter* internal_default_instance() {
    return reinterpret_cast<const MemoryOptimizationParameter*>(
               &_MemoryOptimizationParameter_default_instance_);
  }
  ...
  inline MemoryOptimizationParameter* New() const PROTOBUF_FINAL { return New(NULL); }

  MemoryOptimizationParameter* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  void set_has_optimize_train();
  void clear_has_optimize_train();
  void set_has_optimize_test();
  void clear_has_optimize_test();
...
inline const ::caffe::MemoryOptimizationParameter& NetParameter::mem_param() const {
  ...
  return mem_param_ != NULL ? *mem_param_
                         : *::caffe::MemoryOptimizationParameter::internal_default_instance();
}
